    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			div1 = element("div");
    			add_location(h10, file, 97, 0, 2229);
    			add_location(h11, file, 99, 2, 2278);
    			attr_dev(div0, "id", "main");
    			attr_dev(div0, "class", "fade svelte-14jkpm2");
    			add_location(div0, file, 98, 0, 2247);
    			attr_dev(div1, "id", "status");
    			attr_dev(div1, "class", "empty svelte-14jkpm2");
    			add_location(div1, file, 101, 0, 2297);
    		},
